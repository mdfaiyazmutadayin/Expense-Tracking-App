                    ...
                    <form wire:submit="save" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   class="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent @error('name') border-red-500 @enderror">
                            @error('name')
                        ...
                        <!-- Preview -->
                        <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-700 dark:border-gray-500">
                        ...
                        <div class="flex gap-2">
                            @if($isEditing)
                                <button type="button"
                                        ...
                                        class="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-lg text-gray-400 font-semibold hover:bg-gray-100 dark:hover:bg-gray-700">
                                    Cancel
                                </button>
                            @endif
                            <button type="submit"
                    ...
                    @if($categories->count() > 0)
                        <div class="divide-y divide-gray-200">
                            @foreach($categories as $category)
                                <div class="p-6 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:bg-gray-700 transition" wire:key="category-{{ $category->id }}">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-4 flex-1">
                                            ...
                                            <div class="flex-1">
                                                <h4 class="text-lg font-semibold text-gray-700 dark:text-gray-300">{{ $category->name }}</h4>
